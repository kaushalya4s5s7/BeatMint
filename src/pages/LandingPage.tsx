...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white scroll-section">
      {showTooltip && (
        <div className="fixed top-1/4 left-1/2 transform -translate-x-1/2 z-20 bg-white/10 backdrop-blur-lg rounded-xl p-6 max-w-md"></div>
      )}
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex gap-8">
              ...
              <a href="#trending" className="text-gray-400 hover:text-white">
                Trending
              </a>
              <a href="#collection" className="text-gray-400 hover:text-white">
                Collection
              </a>
        ...
        <div className="max-w-7xl mx-auto px-6 pt-24">
          ...
          <div className="max-w-lg slide-in" style={{ animationDelay: "0.2s" }}>
            <p className="text-gray-400 text-lg mb-8">
              Collect exclusive music NFTs from top artists, join our community,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-400 text-lg mb-8">
                Connect with other music NFT collectors, artists, and
                enthusiasts. Be part of the future of music ownership.
              </p>
              <button className="bg-neon-green text-black px-8 py-3 rounded-full text-lg font-medium hover:bg-opacity-90 transition-all">
                Join Discord →
              </button>
