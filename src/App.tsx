...
function App() {
  ...
  return (
      ...
      <nav className="fixed w-full z-50 px-6 py-4 bg-black/80 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="bg-white/10 px-6 py-2 rounded-full text-white hover:bg-white/20 transition-all">
              CONNECT WALLET
            </button>
   ...
   <h1 className="hero-title text-2xl md:text-9xl mb-6 md:mb-0 w-full md:w-1/3 slide-in">
     BeatMint<br />
     Music NFTs<br />
     Collection
   </h1>
